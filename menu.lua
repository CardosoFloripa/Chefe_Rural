...
function scene:create( event )
	...
	local bg = display.newImageRect (sceneGroup, "imagens/newGame/bg.png", 480, 320 )
    bg.x = display.contentCenterX
    bg.y = display.contentCenterY

-------------------- BOTÃO 1  NEW GAME ---------------------

    local botao1 = display.newImageRect (sceneGroup,"imagens/newGame/newGame.png", 102,37)
    botao1.x = display.contentCenterX -150
    botao1.y = display.contentCenterY +85
    botao1:addEventListener ("tap", gotoGame)

    local botao2 = display.newImageRect (sceneGroup,"imagens/newGame/botao_Level.png", 102,37)
    botao2.x = display.contentCenterX +150
    botao2.y = display.contentCenterY +85
    botao2:addEventListener ("tap", gotoLevel)

    local botao3 = display.newImageRect (sceneGroup, "imagens/newGame/botao_continue.png", 102,37)
